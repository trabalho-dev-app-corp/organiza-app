...
insert into organiza.usuario (role, is_account_non_expired, is_account_non_locked, is_credentials_non_expired, is_enabled, password, username, nome, email, afiliacao) values ("ADMIN", true, true, true, true, "$2a$10$6h8SXUYu.6F6pgtY0QSjeu3EFBYEq5eBjvzXKn2HO5.oYyIkcPswO", "Administrador", "Admnistrador Padrao", "admadmadm@gmail.com", "nenhuma");